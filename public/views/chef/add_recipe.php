...
<body class="w-full bg-no-repeat bg-cover">
    ...
    <main class="bgColor-1 w-11/12 h-auto m-0-auto ff-pri fx mt-4 ">
        ...
        <div class="bgColor-1 w-9/12 h-auto m-0-auto shadow">
            ...
            <h3 class="w-full py-2 txt-h-c color-pri-700">Add New Recipe</h3>
            ...
            class="w-full bgColor-1 h-auto py-5">
                ...
                <div class="w-6/12 fx fx-j-btw m-0-auto py-2">
                    <label class="fw-bold fs-sm" for="photo">photo</label>
                ...
                <div class="w-6/12 fx fx-j-btw m-0-auto py-2">
                    ...
                    <input type="number" name="price"  placeholder="eg: 200"
                     class="bgColor-1-400 py-2 px-4 w-9/12 outline-0
                    border focus:b-color-pri outline-0 rounded color-1
                    color-2-700">
                </div>
                ...
                <div class="w-6/12 fx fx-j-btw m-0-auto py-2">
                    <label class="fw-bold fs-sm" for="category_id">Category</label>
                    <select  class="bgColor-1-400 py-2 px-4 w-9/12 outline-0
                    border focus:b-color-pri outline-0 rounded color-1
                    color-2-700" name="category_id">
                    <option value="">
                        Choose Category
                    </option>
                ...
                <div class="w-6/12 fx fx-j-a  m-0-auto">
                    <button id="add_recipe_btn" type="button" name="button"
                    ...
                    onclick="(new Ajax).form('add_recipe_form')
                                       .loader('add_recipe_btn')
                                       .flush('response')
                                       .send();">
