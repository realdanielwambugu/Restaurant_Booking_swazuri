            ...
            <table class="table-auto border-collapse bgColor-trans m-0-auto">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 color-pri">Delivery Street/Town</th>
                ...
                <tbody class="txt-h-c">
                    ...
                    <tr class="bgColor-1 border-8 b-solid b-color-1">
                        ...
                        <td class="px-4 py-1 color-2-600 border-0"> <?= $delivery->area ?> </td>
                        <td class="px-4 py-1 color-2-600 border-0"> Ksh <?= $delivery->cost ?> </td>

                        <td class="px-2 py-1 color-pri">
                            <a href="/delete_delivery_area/<?= $delivery->id ?>" class="no-line">
