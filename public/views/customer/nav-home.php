        ...
        <nav id="nav"  class="w-full lg:w-9/12 xs:hide fx
         fx-j-btw fx-i-c ">
            ...
            lg:h-full pb-5 lg:pb-0 ls-wide fs-md color-3-600 list-none">
                ...
                <li class="dropdown pointer py-2 lg:py-0 color-1">
                    <i class="fa fa-list px-1"></i> Categories
                    <div class="bgColor-sec-600 w-32 hide absolute shadow z-10 dropdown-content py-2">

                        <?php foreach (category()->all() as $category): ?>

                            <a href="/home/<?=$category->id?>"
                             class="block color-1 no-line pl-3 pb-2 hover:bgColor-sec-800">
                                <?= $category->name ?>
                            </a>
                ...
                <?php if (auth()->check()): ?>
                    ...
                    <a href="/cart" class="no-line">
                        <li id="work" class="pointer py-2 lg:py-0 color-1">
                            ...
                            class="bgColor-1 rounded-full px-1 color-pri">
                                <?= cart_count() ?>
                            </span>
                        </li>
                    </a>
